...
<img src="../../assets/images/20200329python/image-20220407191217938.png" alt="image-20220407191217938" style="zoom:67%;" />
...
使用示例：（注意：在windows中Process()必须放到`if name == "main"`:下）
